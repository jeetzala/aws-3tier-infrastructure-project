...
The infrastructure consists of a custom VPC with public and private subnets, frontend and backend Auto Scaling Groups, and an Amazon RDS MySQL database deployed following AWS networking and security best practices.
